...
import { BaseLoader, BaseModel, SIMPLE_MODELS, DEFAULT_INSERT_BATCH_SIZE, } from '@llm-tools/embedjs-interfaces';
import { cleanString, getUnique } from '@llm-tools/embedjs-utils';
export class RAGApplication {
    debug = createDebugMessages('embedjs:core');
    ...
    async getEmbeddings(cleanQuery, limitsPerDoc) {
        ...
        const unfilteredResultSet = await this.vectorDatabase.similaritySearch(queryEmbedded, this.searchResultCount + 10, limitsPerDoc);
