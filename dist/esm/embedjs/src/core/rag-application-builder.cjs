...
const memory_store_js_1 = require("../store/memory-store.cjs");
...
class RAGApplicationBuilder {
    ...
    constructor() {
        ...
        this.model = embedjs_interfaces_1.SIMPLE_MODELS.OPENAI_GPT4_TURBO;
        ...
        this.store = new memory_store_js_1.MemoryStore();
    }
    /**
