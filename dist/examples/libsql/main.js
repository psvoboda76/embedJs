...
init_src3();
init_src4();
var databasePath = path.resolve("./examples/libsql/data.db");
var ragApplication = await new RAGApplicationBuilder().setStore(new LibSqlStore({ path: databasePath })).setVectorDatabase(new LibSqlDb({ path: databasePath })).setEmbeddingModel(new OpenAiEmbeddings()).setModel(2 /* OPENAI_GPT4_O */).build();
